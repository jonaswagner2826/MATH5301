...
\begin{theorem}
        ...
        \begin{lemma}
            ...
            \begin{proof}
                \begin{multline*} 
                    ...
                    % \alpha^2 \sum_{i=1}^n \abs{x_i}^2 
                    %     \leq \qty(\sum_{i=1}^n (\abs{x_i}^2)^{1/2}) \qty(\sum_{j=1}^n (\abs{x_j}^2)^{1/2}) 
                    %     \leq \beta^2 \sum_{i=1}^n \abs{x_i}^2\\
                \end{multline*}
    ...
    %                     \implies \exists{\alpha,\beta \in \R_{>0}} \st \forall_{x\in \R}
    %                     \alpha \norm{x}_p \leq \norm{x}_1 \leq \beta \norm{x}_p\\
    %                 \alpha \qty(\sum_{i=1}^n \abs{x_i}^p)^{1/p} \leq \sum_{i=1}^n \abs{x_i} \leq \beta \qty(\sum_{i=1}^n \abs{x_i}^p)^{1/p}\\
    %                 \qty(\alpha \qty(\sum_{i=1}^n \abs{x_i}^p)^{1/p} \leq \sum_{i=1}^n \abs{x_i}) 
    %                     \land \qty(\sum_{i=1}^n \abs{x_i} \leq \beta \qty(\sum_{i=1}^n \abs{x_i}^p)^{1/p})\\
    %                 \qty(\qty(\qty(\sum_{i=1}^n \abs{x_i}^p)^{1/p})^p \leq \qty(\frac{1}{\alpha} \sum_{i=1}^n \abs{x_i})^p)
    %                     \land \qty(\qty(\frac{1}{\beta} \sum_{i=1}^n \abs{x_i})^p \leq \qty(\qty(\sum_{i=1}^n \abs{x_i}^p)^{1/p})^p)\\
    %                 \qty(\sum_{i=1}^n \abs{x_i}^p \leq \sum_{i=1}^n \frac{1}{\alpha^p}\abs{x_i}^p)
    %                     \land \qty(\sum_{i=1}^n \frac{1}{\beta^p} \abs{x_i}^p \leq \sum_{i=1}^n \abs{x_i}^p)\\
    %             \end{multline*}
    %             Clearly, this is true for when $\alpha \in (0,1]$ and $\beta \in [1,\infty)$; therefore $\norm{\cdot}_1 \sim \norm{\cdot}_p$.
    %         \end{proof}
    %     \end{lemma}
    ...
    %                 \qty(\alpha \max_{i=1}^n \abs{x_i} \leq \sum_{i=1}^n \abs{x_i}) 
    %                     \land \qty(\sum_{i=1}^n \abs{x_i} \leq \beta \max_{i=1}^n \abs{x_i})\\
    %             \end{multline*}
    ...
    %         \end{proof}
    %     \end{lemma}
    %     From the previous lemas it is clear that 
    \end{proof}
\end{theorem}
